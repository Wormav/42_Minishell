...
/*   Updated: 2025/02/12 13:09:01 by jlorette         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <minishell.h>

void	handle_pipe_child_left(t_ast *ast, t_env **env_lst, int pipefd[2], t_data *data)
{
    close(pipefd[0]);
...
void	handle_pipe_child_right(t_ast *ast, t_env **env_lst, int pipefd[2], t_data *data)
{
    int	flag_exit = 1;
